...
def add_ames_cond(input_path,
    ...
    if not os.path.isfile(data_file):
        sys.stdout.write(f'Downloading AMES-Cond model spectra {label}...')
        sys.stdout.flush()
    ...
    sys.stdout.write(f'Unpacking AMES-Cond model spectra {label}...')
    sys.stdout.flush()
    ...
    for _, _, file_list in os.walk(data_folder):
        for filename in sorted(file_list):
            ...
            if filename.startswith('lte') and filename.endswith('.gz'):
                sys.stdout.write('\rAdding AMES-Cond model spectra... '+filename+'   ')
                sys.stdout.flush()
    ...
    sys.stdout.write('\rAdding AMES-Cond model spectra... [DONE]'
                     '                                  \n')
