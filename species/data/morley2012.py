...
def add_morley2012(
    ...
    if not os.path.isfile(data_file):
        print(
            "Downloading Morley et al. (2012) model spectra (141 MB)...",
            end="",
            flush=True,
        )
    ...
    print(
        "Unpacking Morley et al. (2012) model spectra (141 MB)...", end="", flush=True
    )
    ...
    for _, _, file_list in os.walk(data_folder):
        for filename in sorted(file_list):
            if filename[:11] == "morley2012_":
                ...
                print_message = (
                    f"Adding Morley et al. (2012) model spectra... {filename}"
                )
    ...
    data_util.write_data("morley-2012", ["teff", "logg", "fsed"], database, data_sorted)
